...
Identified and resolved a GitHub Actions CI failure caused by formatting inconsistencies in files generated by the Cloudflare CLI. Fixed by running the project's own `oxfmt` formatter and committing the corrected files.